...
import enpointApiRoutes from '@/endpoint_api/infrastructure/driving-adapter/api-rest/routes'

const loggerMiddleware = new LoggerMiddleware()
const route = Router() 
route.use(ROUTE_VERSION, loggerMiddleware.logRequestInfo, applicationApiRoutes)
route.use(ROUTE_VERSION, loggerMiddleware.logRequestInfo, enpointApiRoutes)
